/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1b120ca57a873b794c0a77767cccfc5d)
// Runtime types generated with workerd@1.20260804.1 2026-08-11
interface __BaseEnv_Env {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	GROK_X_SEARCH_MODEL: "grok-4.5";
	MCP_URL_TOKEN: string;
	ADMIN_URL_TOKEN: string;
	TOKEN_ENCRYPTION_KEY: string;
	GROK_STATE: DurableObjectNamespace<import("./src/worker").GrokState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GrokState";
	}
